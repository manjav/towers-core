...
class FieldProvider 
{
	...
	public function new() 
	{
		...
		fields.set( "battle_701" , new Battle_701( 701, "battle_701", false, false, false, "110,160,220" ) );
		fields.set( "battle_702" , new Battle_702( 702, "battle_702", false, false, false, "110,160,220" ) );
	}
}