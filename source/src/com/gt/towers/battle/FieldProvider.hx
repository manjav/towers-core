...
class FieldProvider 
{
	...
	public function new(game:Game) 
	{
		...
		quests.set( "quest_10" , new Quest_10( 10, "quest_10", false, false, false, "70,100,120,20" ) );
		quests.set( "quest_11" , new Quest_11( 11, "quest_11", false, false, false, "70,100,120,20" ) );
		quests.set( "quest_12" , new Quest_12( 12, "quest_12", false, false, false, "50,80,100,20" ) );
		quests.set( "quest_13" , new Quest_13( 13, "quest_13", false, false, false, "50,80,100,20" ) );
		quests.set( "quest_14" , new Quest_14( 14, "quest_14", false, false, false, "50,80,100,20" ) );
		quests.set( "quest_15" , new Quest_15( 15, "quest_15", false, false, false, "60,90,115,20" ) );
		quests.set( "quest_16" , new Quest_16( 16, "quest_16", false, false, false, "60,90,115,20" ) );
		quests.set( "quest_17" , new Quest_17( 17, "quest_17", false, false, false, "80,120,170,20" ) );
		quests.set( "quest_18" , new Quest_18( 18, "quest_18", false, false, false, "100,150,220,20" ) );
		quests.set( "quest_19" , new Quest_19( 19, "quest_19", false, false, false, "100,150,220,20" ) );
		quests.set( "quest_20" , new Quest_20( 20, "quest_20", false, false, false, "100,150,220,20" ) );
		quests.set( "quest_21" , new Quest_21( 21, "quest_21", false, false, false, "100,150,220,20" ) );
		quests.set( "quest_22" , new Quest_22( 22, "quest_22", false, false, false, "100,150,220,20" ) );
		quests.set( "quest_23" , new Quest_23( 23, "quest_23", false, false, false, "100,150,220,20" ) );
		quests.set( "quest_24" , new Quest_24( 24, "quest_24", false, false, false, "100,150,220,20" ) );
		quests.set( "quest_25" , new Quest_25( 25, "quest_25", false, false, false, "100,150,220,20" ) );
		quests.set( "quest_26" , new Quest_26( 26, "quest_26", false, false, false, "110,160,250,20" ) );
		quests.set( "quest_27" , new Quest_27( 27, "quest_27", false, false, false, "110,160,250,20" ) );
		quests.set( "quest_28" , new Quest_28( 28, "quest_28", false, false, false, "110,160,250,20" ) );
		quests.set( "quest_29" , new Quest_29( 29, "quest_29", false, false, false, "110,160,250,20" ) );
