...
class FieldProvider 
{
	...
	public function new(game:Game) 
	{
		...
		quests.set( "quest_4" , new Quest_4( 4, "quest_4", "", "", "", "60,70,100,20" ) );
		...
		quests.set( "quest_12" , new Quest_12( 12, "quest_12", "", "", "", "50,70,90,20" ) );
		quests.set( "quest_13" , new Quest_13( 13, "quest_13", "", "", "", "50,70,90,20" ) );
		quests.set( "quest_14" , new Quest_14( 14, "quest_14", "", "", "", "60,80,90,20" ) );
		quests.set( "quest_15" , new Quest_15( 15, "quest_15", "", "", "", "60,100,150,20" ) );
		quests.set( "quest_16" , new Quest_16( 16, "quest_16", "", "", "", "60,100,150,20" ) );
		quests.set( "quest_17" , new Quest_17( 17, "quest_17", "", "", "", "60,100,150,20" ) );
		quests.set( "quest_18" , new Quest_18( 18, "quest_18", "", "", "", "60,100,150,20" ) );
		quests.set( "quest_19" , new Quest_19( 19, "quest_19", "", "", "", "60,100,170,30" ) );
		quests.set( "quest_20" , new Quest_20( 20, "quest_20", "", "", "", "60,100,170,30" ) );
		quests.set( "quest_21" , new Quest_21( 21, "quest_21", "", "", "", "70,120,180,30" ) );
		quests.set( "quest_22" , new Quest_22( 22, "quest_22", "", "", "", "70,120,180,30" ) );
		quests.set( "quest_23" , new Quest_23( 23, "quest_23", "", "", "", "70,120,180,30" ) );
		quests.set( "quest_24" , new Quest_24( 24, "quest_24", "", "", "", "70,120,180,30" ) );
		quests.set( "quest_25" , new Quest_25( 25, "quest_25", "", "", "", "100,150,210,30" ) );
		quests.set( "quest_26" , new Quest_26( 26, "quest_26", "", "", "", "110,150,210,30" ) );
		quests.set( "quest_27" , new Quest_27( 27, "quest_27", "", "", "", "120,150,210,30" ) );
		quests.set( "quest_28" , new Quest_28( 28, "quest_28", "", "", "", "130,160,210,30" ) );
		quests.set( "quest_29" , new Quest_29( 29, "quest_29", "", "", "", "140,170,210,30" ) );
