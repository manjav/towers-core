...
class FieldProvider 
{
	...
	public function new(game:Game) 
	{
		...
		quests.set( "quest_3" , new Battle_1( 3, "quest_3", "", "", "", "40,60,75,20" ) );
		quests.set( "quest_4" , new Battle_3( 4, "quest_4", "", "", "", "50,70,100,20" ) );
		quests.set( "quest_5" , new Battle_4( 5, "quest_5", "", "", "", "50,70,100,20" ) );
		quests.set( "quest_6" , new Battle_5( 6, "quest_6", "", "", "", "70,100,150,20" ) );
		quests.set( "quest_7" , new Battle_101( 7, "quest_7", "", "", "", "70,100,150,20" ) );
		quests.set( "quest_8" , new Battle_102( 8, "quest_8", "", "", "", "70,100,150,20" ) );
		quests.set( "quest_9" , new Battle_103( 9, "quest_9", "", "", "", "40,60,80,20" ) );
		quests.set( "quest_10" , new Battle_104( 10, "quest_10", "", "", "", "50,70,90,20" ) );
		quests.set( "quest_11" , new Battle_105( 11, "quest_11", "", "", "", "50,70,90,20" ) );
		quests.set( "quest_12" , new Battle_106( 12, "quest_12", "", "", "", "50,70,90,20" ) );
		quests.set( "quest_13" , new Battle_107( 13, "quest_13", "", "", "", "50,70,90,20" ) );
		quests.set( "quest_14" , new Battle_108( 14, "quest_14", "", "", "", "60,80,90,20" ) );
		quests.set( "quest_15" , new Battle_201( 15, "quest_15", "", "", "", "60,100,150,20" ) );
		quests.set( "quest_16" , new Battle_202( 16, "quest_16", "", "", "", "60,100,150,20" ) );
		quests.set( "quest_17" , new Battle_203( 17, "quest_17", "", "", "", "60,100,150,20" ) );
		quests.set( "quest_18" , new Battle_204( 18, "quest_18", "", "", "", "60,100,150,20" ) );
		quests.set( "quest_19" , new Battle_205( 19, "quest_19", "", "", "", "60,100,170,30" ) );
		quests.set( "quest_20" , new Battle_301( 20, "quest_20", "", "", "", "60,100,170,30" ) );
		quests.set( "quest_21" , new Battle_302( 21, "quest_21", "", "", "", "70,120,180,30" ) );
		quests.set( "quest_22" , new Battle_303( 22, "quest_22", "", "", "", "70,120,180,30" ) );
		quests.set( "quest_23" , new Battle_304( 23, "quest_23", "", "", "", "70,120,180,30" ) );
		quests.set( "quest_24" , new Battle_305( 24, "quest_24", "", "", "", "70,120,180,30" ) );
		quests.set( "quest_25" , new Battle_306( 25, "quest_25", "", "", "", "100,150,210,30" ) );
		quests.set( "quest_26" , new Battle_307( 26, "quest_26", "", "", "", "110,150,210,30" ) );
		quests.set( "quest_27" , new Battle_308( 27, "quest_27", "", "", "", "120,150,210,30" ) );
		quests.set( "quest_28" , new Battle_309( 28, "quest_28", "", "", "", "130,160,210,30" ) );
		quests.set( "quest_29" , new Battle_310( 29, "quest_29", "", "", "", "140,170,210,30" ) );
