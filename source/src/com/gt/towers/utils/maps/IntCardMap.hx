...
class IntCardMap
{
	...
	#if java
	private var _map:java.util.HashMap<Int, Card>;
	#elseif flash
	...
	{
		#if java
		_map = new java.util.HashMap<Int, Card>();
		#elseif flash
	...
	**/
	public function values():NativeArray<Card>
	{
		var keis:NativeArray<Dynamic> = _map.keySet().toArray();
		var ret:NativeArray<Card> = new NativeArray<Card>(keis.length);
		var i:Int = 0;
		while (i < keis.length)
		{
	...
	**/
	...
	/**
		...
		The order of values is undefined.
	**/
	public function values():Vector<Card>
	{
		var ret:Vector<Card> = new Vector<Card>();
		for (value in _map)
			ret.push(value);
		return ret ;
	}
